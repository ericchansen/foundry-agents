...
in [`deploy-hosted-agent.yml`](https://github.com/ericchansen/foundry-agents/blob/main/.github/workflows/deploy-hosted-agent.yml).
...
[the GitHub Actions deployment guide]({{ '/github-actions-hosted-agent/' | relative_url }}).
