...
description: Build, deploy, and operate the hosted-agent lab through azd, Python, REST, or source code.
permalink: /implementation-reference/
section: reference
---

# Microsoft Foundry hosted-agent implementation reference

> **Learning this topic? Start with the [course]({{ '/course/' | relative_url }}).** The course is an
> instructor-led sequence with predictions, learner-performed commands,
> troubleshooting exercises, and teach-back checkpoints. This page is the
...
requirements]({{ '/hosted-agent-requirements/' | relative_url }}).
