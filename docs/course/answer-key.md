...
description: Check course exercise answers after recording a prediction and an attempt.
permalink: /course/answer-key/
section: course
---

# Exercise answer key

> **Spoiler warning:** Record your prediction, attempt the exercise, and collect
> evidence before reading the corresponding answer.
