---
title: "Module 8: Troubleshooting lab"
description: Diagnose realistic hosted-agent failures one boundary at a time.
permalink: /course/modules/08-troubleshooting/
section: course
module: 8
course_order: 11
previous_title: "Module 12: Source code"
previous_url: /course/modules/12-source-code/
next_title: "Module 9: Capstone"
next_url: /course/modules/09-capstone/
---
...
Use the [troubleshooting playbook]({{ '/troubleshooting-playbook/' | relative_url }})
and the [failure-lab instructions]({{ '/course/failure-lab/' | relative_url }}).
