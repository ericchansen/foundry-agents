---
title: "Module 1: The Responses runtime contract"
description: Validate the Responses protocol contract with a locally invoked echo image.
permalink: /course/modules/01-runtime-contract/
section: course
module: 1
course_order: 1
previous_title: "Module 0: Baseline"
previous_url: /course/modules/00-baseline/
next_title: "Module 2: Model and identity"
next_url: /course/modules/02-model-and-identity/
---
