---
title: "Module 0: Baseline and vocabulary"
description: Build the mental model and vocabulary used throughout the hosted-agent course.
permalink: /course/modules/00-baseline/
section: course
module: 0
course_order: 0
next_title: "Module 1: Runtime contract"
next_url: /course/modules/01-runtime-contract/
---
...
Read [the mental model]({{ '/mental-model/' | relative_url }}), then compare it with your
